        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div className="md:col-span-2">
            ...
            <p className="mt-3 text-sm text-gray-500 dark:text-gray-400 max-w-md">
              Set, track, and achieve your personal and team goals with powerful
              visualization tools. Stay motivated and measure your progress as
              you reach new milestones.
            </p>
